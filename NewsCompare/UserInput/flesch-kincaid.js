...
/*Original code from https://github.com/daveross/flesch-kincaid
*All credit to daveross on github*/
'use strict';
...
var rate = exports.rate = function rate(x) {
    return parseInt(206.835 - 1.015 * wordsPerSentence(x) - 84.6 * syllablesPerWord(x));
};

var grade = exports.grade = function grade(x) {
    var gradenum = parseInt(0.39 * wordsPerSentence(x) + 11.8 * syllablesPerWord(x) - 15.59);
    if (gradenum > 12) {
        return "College";
    }
    return gradenum;
